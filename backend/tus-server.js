...
const tusApiPath = '/api/tus/upload'; // TUS endpoint path
...
async function ensureTusStorageDir() {
    try {
        ...
        // If the directory cannot be created, the server might not work correctly.
        // Consider throwing the error or exiting the process depending on desired behavior.
